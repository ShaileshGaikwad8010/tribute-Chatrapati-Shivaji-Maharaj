...
export default function English() {
    ...
    useEffect(() => {
        ...
        observerRef.current = new IntersectionObserver(handleIntersection, {
            threshold: 0.5, // Play video when 50% of the iframe is in view
        });

        // Start observing when the iframeRef is not null
        if (iframeRef.current) {
            observerRef.current.observe(iframeRef.current);
        }

        return () => {
            // Stop observing when unmounting or when the iframeRef changes
            ...
            <main>
                <section id="introduction">
                    <div class="p">
                        ...
                        <h2 id='mainh2'>The Father Of The Indian Neavy</h2>
                        <div class="intro">
                ...
                <section id="bijapur_conflict">
                    ...
                    <div className="iframe">
                        <iframe
                            ...
                            width="1000"
                            height="500"
                            src="https://www.youtube.com/embed/N67Rw600-kc?autoplay=1&mute=1&enablejsapi=1&origin=http://localhost:3000"
                    ...
                    <div className="iframe">
                        <iframe
                            width="1000"
                            height="500"
                            src="https://www.youtube.com/embed/Xr9IJvEO4-8?mute=1"
                            title="300#Baji Prabhu Deshpande#Battle Of Pavan Khind"
                            frameborder="0"
                ...
                <section id="mughal_combat">
                    ...
                    <div className="iframe">
                        <iframe
                            ...
                            width="1000"
                            height="500"
                            src="https://www.youtube.com/embed/NJ6KuSO3QEU?mute=1"
                            title="Veer Shivaji shaista khan  status"
                            frameborder="0"
                    ...
                    <div className="iframe">
                        <iframe
                            width="1000"
                            height="500"
                            src="https://www.youtube.com/embed/_y-EbmIioSo?mute=1"
                            title="After Purandar Treaty || २३ किल्ले कैसे हासिल किया | छ शिवाजी महाराज ने कैसे औरंगज़ेब को पागल बनाया"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin"
                            allowfullscreen
                    ...
                    <div className="iframe">
                        <iframe
                            width="1000"
                            height="500"
                            src="https://www.youtube.com/embed/50f6JzPdxLo?mute=1"
                            title="How Chhatrapati Shivaji Maharaj escape Agra Fort |Shivaji Maharaj vs Aurangzeb"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin"
                            allowfullscreen
